...
public class Start {
	...
	/**
	 * main method. <br>
	 * Calling the GammaAnalysisFrame GUI, the application entry point!
	 * @param args args
	 */
	public static void main(String[] args) {
		// TODO Auto-generated method stub
		loadLookAndFeel();
		SwingUtilities.invokeLater(//new GammaAnalysisFrame());
		// Toolkit.getDefaultToolkit().beep();//audio beep!!!

		// new GammaAnalysisFrame();
				new Runnable() {
					public void run() {
