...
public class AboutFrame extends JFrame {
	 ...
	 */
	public AboutFrame(GammaAnalysisFrame mf) {
		...
		jLabel1.setForeground(GammaAnalysisFrame.foreColor);
		jLabel2.setForeground(GammaAnalysisFrame.foreColor);
		lbAuthor.setForeground(GammaAnalysisFrame.foreColor);
		lbVersion.setForeground(GammaAnalysisFrame.foreColor);
		jLabel7.setForeground(GammaAnalysisFrame.foreColor);
		textLicense.setBackground(GammaAnalysisFrame.textAreaBkgColor);
		textLicense.setForeground(GammaAnalysisFrame.textAreaForeColor);
	...
	private void createGUI() {
		...
		jPanel1.setBackground(GammaAnalysisFrame.bkgColor);
		...
		jPanel3.setBackground(GammaAnalysisFrame.bkgColor);
